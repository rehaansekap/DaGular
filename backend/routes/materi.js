...
router.get("/:id", async (req, res) => {
  ...
  try {
    const [materi] = await db.query("SELECT * FROM materi WHERE id = ?", [id]);
...
router.delete("/delete/:id", async (req, res) => {
  ...
  try {
    await db.query("DELETE FROM materi_konten WHERE materi_id = ?", [id]);
