...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2026 at 06:25 AM
...
(5, 2, 1, 'http://localhost:5000/uploads/1784606884527-White and Pink Simple Mind Map Brainstorm.png', '2026-07-21 04:08:04');
...
--
-- Table structure for table `pjbl_learning_evaluations`
--

CREATE TABLE `pjbl_learning_evaluations` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `pertemuan` int(11) NOT NULL,
  `group_name` varchar(150) DEFAULT NULL,
  `memorable_experience` text DEFAULT NULL,
  `learning_difficulty` text DEFAULT NULL,
...
--
-- Dumping data for table `pjbl_learning_evaluations`
--

INSERT INTO `pjbl_learning_evaluations` (`id`, `user_id`, `pertemuan`, `group_name`, `memorable_experience`, `learning_difficulty`, `improvement_suggestion`, `total_score`, `max_score`, `final_score`, `category`, `answered_count`, `status`, `submitted_at`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Kelompok 1', 'Selama pembelajaran kita jadi lebih aktif untuk mengerjakan tugasnya karena ini berbasis proyek yang mengharuskan kita berpikir kreatif', 'Berkomunikasi dengan teman kelompok karena tidak terlalu dekat', 'Adakan reward kecil kecilan supaya murid lebih semangat lagi', 62, 90, 68.89, 'Cukup', 18, 'submitted', '2026-07-17 15:17:54', '2026-07-17 08:17:54', '2026-07-17 08:17:54');

-- --------------------------------------------------------

--
-- Table structure for table `pjbl_learning_evaluation_scores`
--

CREATE TABLE `pjbl_learning_evaluation_scores` (
  `id` int(11) NOT NULL,
  `evaluation_id` int(11) NOT NULL,
  `indicator_key` varchar(100) NOT NULL,
  `indicator_label` varchar(150) NOT NULL,
...
--
-- Dumping data for table `pjbl_learning_evaluation_scores`
--

INSERT INTO `pjbl_learning_evaluation_scores` (`id`, `evaluation_id`, `indicator_key`, `indicator_label`, `item_key`, `statement_text`, `score`, `created_at`, `updated_at`) VALUES
(1, 1, 'pemahaman_materi', 'Pemahaman Materi', 'pemahaman_1', 'Saya memahami materi desain setelah mengikuti pembelajaran ini.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(2, 1, 'pemahaman_materi', 'Pemahaman Materi', 'pemahaman_2', 'Proyek yang dikerjakan membantu saya memahami materi dengan lebih mudah.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(3, 1, 'pemahaman_materi', 'Pemahaman Materi', 'pemahaman_3', 'Saya dapat menghubungkan materi pembelajaran dengan tugas proyek yang dibuat.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(4, 1, 'keaktifan', 'Keaktifan dan Keterlibatan', 'keaktifan_1', 'Saya aktif mengikuti diskusi selama kegiatan proyek.', 2, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(5, 1, 'keaktifan', 'Keaktifan dan Keterlibatan', 'keaktifan_2', 'Saya ikut berkontribusi dalam mengerjakan tugas kelompok.', 1, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(6, 1, 'keaktifan', 'Keaktifan dan Keterlibatan', 'keaktifan_3', 'Saya berusaha menyelesaikan tugas sesuai tanggung jawab saya.', 2, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(7, 1, 'kerja_sama', 'Kerja Sama Kelompok', 'kerja_sama_1', 'Saya dapat bekerja sama dengan anggota kelompok.', 2, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(8, 1, 'kerja_sama', 'Kerja Sama Kelompok', 'kerja_sama_2', 'Kelompok saya membagi tugas dengan cukup jelas.', 2, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(9, 1, 'kerja_sama', 'Kerja Sama Kelompok', 'kerja_sama_3', 'Anggota kelompok saling membantu saat mengalami kesulitan.', 2, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(10, 1, 'proses_pjbl', 'Proses Project Based Learning', 'pjbl_1', 'Kegiatan proyek membuat pembelajaran terasa lebih menarik.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(11, 1, 'proses_pjbl', 'Proses Project Based Learning', 'pjbl_2', 'Tahapan membuat rencana proyek membantu kelompok bekerja lebih terarah.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(12, 1, 'proses_pjbl', 'Proses Project Based Learning', 'pjbl_3', 'Jadwal proyek membantu kelompok mengatur waktu pengerjaan.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(13, 1, 'platform', 'Penggunaan Media atau Platform', 'platform_1', 'Fitur LKPD membantu saya memahami tugas yang harus dikerjakan.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(14, 1, 'platform', 'Penggunaan Media atau Platform', 'platform_2', 'Fitur Desain Proyek membantu kelompok menyusun rencana kerja.', 5, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(15, 1, 'platform', 'Penggunaan Media atau Platform', 'platform_3', 'Tampilan platform cukup mudah digunakan dalam proses pembelajaran.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(16, 1, 'pengalaman_belajar', 'Pengalaman Belajar', 'pengalaman_1', 'Saya merasa lebih percaya diri setelah menyelesaikan proyek.', 4, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(17, 1, 'pengalaman_belajar', 'Pengalaman Belajar', 'pengalaman_2', 'Saya merasa pembelajaran berbasis proyek membantu saya belajar secara aktif.', 5, '2026-07-17 08:17:54', '2026-07-17 08:17:54'),
(18, 1, 'pengalaman_belajar', 'Pengalaman Belajar', 'pengalaman_3', 'Saya puas dengan pengalaman belajar melalui kegiatan proyek ini.', 5, '2026-07-17 08:17:54', '2026-07-17 08:17:54');

-- --------------------------------------------------------

--
-- Table structure for table `pjbl_project_plans`
--

CREATE TABLE `pjbl_project_plans` (
  `id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `pertemuan` int(11) NOT NULL,
...
--
-- Dumping data for table `pjbl_project_plans`
--

INSERT INTO `pjbl_project_plans` (`id`, `user_id`, `pertemuan`, `group_name`, `members_text`, `project_plan`, `project_rules`, `selected_activities`, `tools_materials`, `status`, `submitted_at`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'Kelompok 1', '1. Davina\n2. Dimas', 'Kelompok kami akan mengerjakan lkpd pertemuan 1, dengan mengisi jawaban sambil berdiskusi dengan tema kelompok', '1. Setiap anggota wajib mengerjakan tugas masing masing\n2. Setiap anggota harus pro aktif di kelas', '1. Davina mengetik di website\n2. Dimas mencari sumber sumber yang kredibel untuk membantu mengerjakan soal', '1. laptop\n2. buku\n3. pensil', 'submitted', '2026-07-17 13:50:49', '2026-07-16 10:56:22', '2026-07-17 06:50:49'),
(2, 1, 2, 'Kelompok 1', '1. davina\n2. dimas', 'Kelompok kami akan mengerjakan lkpd 2', '1. setiap anggota harus mengerjakan tugas\n2. harus akur', '1. davina menjawab soal no 1\n2. dimas menjawab soal no 2', '1. laptop\n2. buku\n3. pensi\n4. penghapus\n5. internet', 'submitted', '2026-07-21 11:04:22', '2026-07-21 04:04:22', '2026-07-21 04:04:22');

-- --------------------------------------------------------

--
-- Table structure for table `pjbl_project_schedules`
--

CREATE TABLE `pjbl_project_schedules` (
  `id` int(11) NOT NULL,
  `plan_id` int(11) NOT NULL,
  `schedule_order` int(11) NOT NULL DEFAULT 1,
...
--
-- Dumping data for table `pjbl_project_schedules`
--

INSERT INTO `pjbl_project_schedules` (`id`, `plan_id`, `schedule_order`, `schedule_date`, `schedule_activity`, `pic_name`, `target_output`, `note`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2026-07-17', 'Mengisi LKPD 1', 'Davina', 'Submit LKPD 1', NULL, '2026-07-17 06:50:49', '2026-07-17 06:50:49'),
(2, 2, 1, '2026-07-21', 'membuat sketsa kasar', 'davina', 'sketsa kasar', NULL, '2026-07-21 04:04:22', '2026-07-21 04:04:22'),
(3, 2, 2, '2026-07-21', 'membuat mind map', 'dimas', 'mind map', NULL, '2026-07-21 04:04:22', '2026-07-21 04:04:22');
...
(19, 5, 37, 1, '{\"1. Project Overview:\":\"aa\",\"2. Tujuan:\":\"a\",\"3. Target Audiens:\":\"a\",\"4. Pesan Utama:\":\"a\",\"5. Tone & Mood (Nuansa, Warna)\":\"a\",\"6. Elemen Wajib (Visual, Identitas):\":\"a\",\"7. Spesifikasi Teknis (Output Media, Ukuran, Software):\":\"a\"}', NULL, 0, 0, 'elemen wajib visual identitas: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\npesan utama: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\nproject overview: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\nspesifikasi teknis output media ukuran software: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ntarget audiens: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ntone mood nuansa warna: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ntujuan: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.', '[]', 'auto', 'revision', 0, 0, NULL, '2026-07-16 03:26:20'),
(20, 2, 31, 2, '{\"1. Project Overview. Apa nama proyek ini dan masalah utama apa yang ingin diselesaikan?\":\"a\",\"2. Category/Industry. Di bidang apa proyek ini berjalan? (Pendidikan, Komersial, atau Sosial?).\":\"a\",\"3. Goals/Objectives. Perubahan perilaku apa yang diinginkan sekolah setelah siswa melihat poster ini?\":\"a\",\"4. Target Audience. Siapa sasaran utamanya? Bagaimana karakteristik/usia mereka?\":\"a\",\"5. The Message. Apa pesan kunci atau slogan utama yang harus menonjol?\":\"a\",\"6. Deliverables. Apa output fisik desainnya dan di mana lokasi penempatannya?\":\"a\",\"7. Timeline. Kapan desain ini harus selesai?\":\"a\",\"8. Constraints. Apa saja batasan atau tantangan teknis yang harus diperhatikan dalam desain ini?\":\"a\"}', NULL, 0, 0, 'category industry di bidang apa proyek ini berjalan pendidikan komersial atau sosial: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\nconstraints apa saja batasan atau tantangan teknis yang harus diperhatikan dalam desain ini: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ndeliverables apa output fisik desainnya dan di mana lokasi penempatannya: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ngoals objectives perubahan perilaku apa yang diinginkan sekolah setelah siswa melihat poster ini: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\nproject overview apa nama proyek ini dan masalah utama apa yang ingin diselesaikan: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ntarget audience siapa sasaran utamanya bagaimana karakteristik usia mereka: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\nthe message apa pesan kunci atau slogan utama yang harus menonjol: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.\ntimeline kapan desain ini harus selesai: nilai 0. Jawaban ada, tetapi belum sesuai dengan keyword rubrik.', '[]', 'auto', 'revision', 0, 0, NULL, '2026-07-17 02:30:56'),
(21, 2, 31, 3, '{\"1. Project Overview. Apa nama proyek ini dan masalah utama apa yang ingin diselesaikan?\":\"aa\",\"2. Category/Industry. Di bidang apa proyek ini berjalan? (Pendidikan, Komersial, atau Sosial?).\":\"a\",\"3. Goals/Objectives. Perubahan perilaku apa yang diinginkan sekolah setelah siswa melihat poster ini?\":\"a\",\"4. Target Audience. Siapa sasaran utamanya? Bagaimana karakteristik/usia mereka?\":\"a\",\"5. The Message. Apa pesan kunci atau slogan utama yang harus menonjol?\":\"a\",\"6. Deliverables. Apa output fisik desainnya dan di mana lokasi penempatannya?\":\"a\",\"7. Timeline. Kapan desain ini harus selesai?\":\"a\",\"8. Constraints. Apa saja batasan atau tantangan teknis yang harus diperhatikan dalam desain ini?\":\"a\"}', NULL, 0, 0, 'Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial: nilai 0. Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur pendidikan, sekolah, smk, kampanye hemat air, lingkungan sekolah, masyarakat.\nConstraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini: nilai 0. Constraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur kurang dari 5 detik, mudah dipahami, tidak menggurui, tidak galak, tidak mengancam, audiens melintas.\nDeliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya: nilai 0. Deliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur poster cetak, pintu toilet, kamar mandi sekolah, setiap pintu toilet, media cetak.\nGoals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini: nilai 0. Goals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur siswa menutup keran, hemat air, mengurangi pemborosan air, membangun kesadaran, tidak lupa menutup keran, menjaga.\nProject Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan: nilai 0. Project Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur hemat air, keran terbuka, lupa tutup keran, boros air, toilet, kamar mandi.\nTarget Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka: nilai 0. Target Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur siswa smk, remaja, pelajar sekolah, pengguna toilet, siswa yang melintas.\nThe Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol: nilai 0. The Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur tutup keran, hemat air, jangan biarkan air terbuang, pakai air secukupnya, air berharga.\nTimeline Kapan Desain Ini Harus Selesai: nilai 0. Timeline Kapan Desain Ini Harus Selesai masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur 1 hari, 2 hari, 3 hari, beberapa jam, sketsa, desain selesai.', '[]', 'auto', 'revision', 0, 0, NULL, '2026-07-17 07:55:31'),
(22, 2, 31, 4, '{\"1. Project Overview. Apa nama proyek ini dan masalah utama apa yang ingin diselesaikan?\":\"aa\",\"2. Category/Industry. Di bidang apa proyek ini berjalan? (Pendidikan, Komersial, atau Sosial?).\":\"a\",\"3. Goals/Objectives. Perubahan perilaku apa yang diinginkan sekolah setelah siswa melihat poster ini?\":\"a\",\"4. Target Audience. Siapa sasaran utamanya? Bagaimana karakteristik/usia mereka?\":\"target untuk poster ini siswa smk yang menggunakan toilet\",\"5. The Message. Apa pesan kunci atau slogan utama yang harus menonjol?\":\"a\",\"6. Deliverables. Apa output fisik desainnya dan di mana lokasi penempatannya?\":\"a\",\"7. Timeline. Kapan desain ini harus selesai?\":\"a\",\"8. Constraints. Apa saja batasan atau tantangan teknis yang harus diperhatikan dalam desain ini?\":\"a\"}', NULL, 0, 0, 'Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial: nilai 0. Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur pendidikan, sekolah, smk, kampanye hemat air, lingkungan sekolah, masyarakat.\nConstraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini: nilai 0. Constraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur kurang dari 5 detik, mudah dipahami, tidak menggurui, tidak galak, tidak mengancam, audiens melintas.\nDeliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya: nilai 0. Deliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur poster cetak, pintu toilet, kamar mandi sekolah, setiap pintu toilet, media cetak.\nGoals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini: nilai 0. Goals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur siswa menutup keran, hemat air, mengurangi pemborosan air, membangun kesadaran, tidak lupa menutup keran, menjaga.\nProject Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan: nilai 0. Project Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur hemat air, keran terbuka, lupa tutup keran, boros air, toilet, kamar mandi.\nTarget Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka: nilai 4. Target Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka sudah memenuhi nilai minimal. Jawaban sudah memuat unsur siswa smk. Agar lebih lengkap, kamu masih bisa menambahkan unsur remaja, pelajar sekolah, pengguna toilet, siswa yang melintas.\nThe Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol: nilai 0. The Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur tutup keran, hemat air, jangan biarkan air terbuang, pakai air secukupnya, air berharga.\nTimeline Kapan Desain Ini Harus Selesai: nilai 0. Timeline Kapan Desain Ini Harus Selesai masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur 1 hari, 2 hari, 3 hari, beberapa jam, sketsa, desain selesai.', '[\"siswa smk\"]', 'auto', 'revision', 0, 0, NULL, '2026-07-17 08:04:37'),
(23, 5, 37, 2, '{\"1. Project Overview:\":\"a\",\"2. Tujuan:\":\"a\",\"3. Target Audiens:\":\"a\",\"4. Pesan Utama:\":\"a\",\"5. Tone & Mood (Nuansa, Warna)\":\"a\",\"6. Elemen Wajib (Visual, Identitas):\":\"a\",\"7. Spesifikasi Teknis (Output Media, Ukuran, Software):\":\"a\"}', NULL, 0, 0, 'Elemen Wajib Visual Identitas: nilai 0. Elemen Wajib Visual Identitas masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur logo sekolah, tempat sampah, buang sampah, ilustrasi anak, gambar kantin, meja makan.\nPesan Utama: nilai 0. Pesan Utama masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, jagalah kebersihan, rapikan meja, kantin bersih, perut sehat, bersihkan mejamu.\nProject Overview: nilai 0. Project Overview masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur poster kampanye, poster kebersihan, kantin sekolah, kebersihan kantin, membuat poster, mendesain poster.\nSpesifikasi Teknis Output Media Ukuran Software: nilai 0. Spesifikasi Teknis Output Media Ukuran Software masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ukuran A3, poster cetak, poster digital, instagram, feed, adobe illustrator.\nTarget Audiens: nilai 0. Target Audiens masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur seluruh siswa, warga sekolah, semua murid, siswa guru, pengunjung kantin, pedagang kantin.\nTone Mood Nuansa Warna: nilai 0. Tone Mood Nuansa Warna masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ceria, bersahabat, playful, segar, bersih, ramah.\nTujuan: nilai 0. Tujuan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, membuang sampah, kantin bersih, kantin sehat, mengedukasi siswa, menyadarkan siswa.', '[]', 'auto', 'revision', 0, 0, NULL, '2026-07-18 06:03:09'),
(24, 2, 31, 5, '{\"1. Project Overview. Apa nama proyek ini dan masalah utama apa yang ingin diselesaikan?\":\" Tambahkan unsur hemat air, keran terbuka, lupa tutup keran, boros air, toilet, kamar mandi.\",\"8. Constraints. Apa saja batasan atau tantangan teknis yang harus diperhatikan dalam desain ini?\":\"Tambahkan unsur kurang dari 5 detik, mudah dipahami, tidak menggurui, tidak galak, tidak mengancam, audiens melintas.\",\"2. Category/Industry. Di bidang apa proyek ini berjalan? (Pendidikan, Komersial, atau Sosial?).\":\"pendidikan, sekolah, smk, kampanye hemat air, lingkungan sekolah, masyarakat.\",\"3. Goals/Objectives. Perubahan perilaku apa yang diinginkan sekolah setelah siswa melihat poster ini?\":\"Tambahkan unsur siswa menutup keran, hemat air, mengurangi pemborosan air, membangun kesadaran, tidak lupa menutup keran, menjaga.\",\"5. The Message. Apa pesan kunci atau slogan utama yang harus menonjol?\":\"Tambahkan unsur tutup keran, hemat air, jangan biarkan air terbuang, pakai air secukupnya, air berharga.\",\"7. Timeline. Kapan desain ini harus selesai?\":\"Tambahkan unsur 1 hari, 2 hari, 3 hari, beberapa jam, sketsa, desain selesai.\",\"6. Deliverables. Apa output fisik desainnya dan di mana lokasi penempatannya?\":\" Tambahkan unsur poster cetak, pintu toilet, kamar mandi sekolah, setiap pintu toilet, media cetak.\",\"4. Target Audience. Siapa sasaran utamanya? Bagaimana karakteristik/usia mereka?\":\"Agar lebih lengkap, kamu masih bisa menambahkan unsur remaja, pelajar sekolah, pengguna toilet, siswa yang melintas.\"}', NULL, 4, 4, 'Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial: nilai 4. Kategori proyek sangat tepat dan sesuai konteks sekolah.\nConstraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini: nilai 4. Constraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini sudah memenuhi nilai minimal. Jawaban sudah memuat unsur kurang dari 5 detik, mudah dipahami, tidak menggurui, tidak galak, tidak mengancam. Agar lebih lengkap, kamu masih bisa menambahkan unsur visual sederhana.\nDeliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya: nilai 4. Output desain dan lokasi penempatan sangat jelas.\nGoals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini: nilai 4. Tujuan perubahan perilaku sangat jelas dan sesuai masalah.\nProject Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan: nilai 4. Project Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan sudah memenuhi nilai minimal. Jawaban sudah memuat unsur hemat air, keran terbuka, lupa tutup keran, boros air, toilet. Agar lebih lengkap, kamu masih bisa menambahkan unsur sekolah, siswa.\nTarget Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka: nilai 4. Target Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka sudah memenuhi nilai minimal. Jawaban sudah memuat unsur remaja, pelajar sekolah, pengguna toilet, siswa yang melintas. Agar lebih lengkap, kamu masih bisa menambahkan unsur siswa smk.\nThe Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol: nilai 4. Pesan utama jelas, singkat, dan sesuai tujuan poster.\nTimeline Kapan Desain Ini Harus Selesai: nilai 4. Timeline realistis dan sesuai proyek latihan kelas.', '[\"pendidikan\",\"sekolah\",\"smk\",\"kampanye hemat air\",\"lingkungan sekolah\",\"masyarakat\",\"kurang dari 5 detik\",\"mudah dipahami\",\"tidak menggurui\",\"tidak galak\",\"tidak mengancam\",\"audiens melintas\",\"poster cetak\",\"pintu toilet\",\"kamar mandi sekolah\",\"setiap pintu toilet\",\"media cetak\",\"siswa menutup keran\",\"hemat air\",\"mengurangi pemborosan air\",\"membangun kesadaran\",\"tidak lupa menutup keran\",\"hemat air\",\"keran terbuka\",\"lupa tutup keran\",\"boros air\",\"toilet\",\"kamar mandi\",\"hemat\",\"remaja\",\"pelajar sekolah\",\"pengguna toilet\",\"siswa yang melintas\",\"tutup keran\",\"hemat air\",\"jangan biarkan air terbuang\",\"pakai air secukupnya\",\"air berharga\",\"1 hari\",\"2 hari\",\"3 hari\",\"beberapa jam\",\"sketsa\",\"desain selesai\"]', 'auto', 'completed', 1, 4, NULL, '2026-07-21 03:11:06'),
(25, 2, 33, 2, '{\"1. Apa tujuan desain tersebut?\":\"a\",\"2. Siapa target audiensnya?\":\"a\",\"3. Apa elemen yang dominan (warna, tipografi, layout, dll):\":\"a\",\"4. Bagian yang paling pertama menarik perhatian:\":\"a\",\"5. Apakah pesan utama yang langsung terlihat? Jelaskan.\":\"a\",\"6. Bagian mana yang membingungkan?\":\"a\",\"7. Sebutkan 3 masalah pada elemen desainnya:\":\"a\",\"8. Sebutkan 3 masalah pada prinsip desainnya (kontras, keseimbangan, dll):\":\"a\",\"9. Sebutkan 3 masalah menurut hierarki visual:\":\"a\"}', NULL, 0, 0, 'Apakah Pesan Utama Yang Langsung Terlihat Jelaskan: nilai 0. Apakah Pesan Utama Yang Langsung Terlihat Jelaskan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur promosi tempat wisata, mempromosikan wisata, arbuckle, taman hewan arbuckle, kebun binatang arbuckle, wisata keluarga.\nApa Elemen Yang Dominan Warna Tipografi Layout Dll: nilai 0. Apa Elemen Yang Dominan Warna Tipografi Layout Dll masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur warna mencolok, warna terang, warna cerah, warna merah, warna biru, warna kuning.\nApa Tujuan Desain Tersebut: nilai 0. Apa Tujuan Desain Tersebut masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur promosi wisata, mempromosikan wisata, iklan tempat wisata, mengenalkan tempat wisata, taman hiburan, kebun binatang.\nBagian Mana Yang Membingungkan: nilai 0. Bagian Mana Yang Membingungkan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur terlalu banyak teks, kebanyakan tulisan, informasi berlebihan, font kecil, tulisan kekecilan, teks terlalu kecil.\nBagian Yang Paling Pertama Menarik Perhatian: nilai 0. Bagian Yang Paling Pertama Menarik Perhatian masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur headline, judul besar, tulisan besar, teks utama, kata rediscover, rediscover.\nSebutkan 3 Masalah Menurut Hierarki Visual: nilai 0. Sebutkan 3 Masalah Menurut Hierarki Visual masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur pesan utama tidak menonjol, tidak ada yang menonjol, judul tidak kelihatan, fokusnya hilang, urutan baca membingungkan, alur baca bingung.\nSebutkan 3 Masalah Pada Elemen Desainnya: nilai 0. Sebutkan 3 Masalah Pada Elemen Desainnya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur warna terlalu banyak, warna ramai, warna pusing, warna tabrakan, warna mencolok, warna norak.\nSebutkan 3 Masalah Pada Prinsip Desainnya Kontras Keseimbangan Dll: nilai 0. Sebutkan 3 Masalah Pada Prinsip Desainnya Kontras Keseimbangan Dll masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur kontras berlebihan, kontras kurang, warna tabrakan, tidak kelihatan, terlalu mencolok, keseimbangan buruk.\nSiapa Target Audiensnya: nilai 0. Siapa Target Audiensnya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur keluarga, keluarga muda, anak-anak, anak kecil, anak sekolah, wisatawan.', '[]', 'auto', 'revision', 1, 0, NULL, '2026-07-21 03:26:27'),
(26, 5, 37, 3, '{\"1. Project Overview:\":\"a\",\"2. Tujuan:\":\"a\",\"3. Target Audiens:\":\"a\",\"4. Pesan Utama:\":\"a\",\"5. Tone & Mood (Nuansa, Warna)\":\"a\",\"6. Elemen Wajib (Visual, Identitas):\":\"a\",\"7. Spesifikasi Teknis (Output Media, Ukuran, Software):\":\"a\"}', NULL, 0, 0, 'Elemen Wajib Visual Identitas: nilai 0. Elemen Wajib Visual Identitas masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur logo sekolah, tempat sampah, buang sampah, ilustrasi anak, gambar kantin, meja makan.\nPesan Utama: nilai 0. Pesan Utama masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, jagalah kebersihan, rapikan meja, kantin bersih, perut sehat, bersihkan mejamu.\nProject Overview: nilai 0. Project Overview masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur poster kampanye, poster kebersihan, kantin sekolah, kebersihan kantin, membuat poster, mendesain poster.\nSpesifikasi Teknis Output Media Ukuran Software: nilai 0. Spesifikasi Teknis Output Media Ukuran Software masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ukuran A3, poster cetak, poster digital, instagram, feed, adobe illustrator.\nTarget Audiens: nilai 0. Target Audiens masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur seluruh siswa, warga sekolah, semua murid, siswa guru, pengunjung kantin, pedagang kantin.\nTone Mood Nuansa Warna: nilai 0. Tone Mood Nuansa Warna masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ceria, bersahabat, playful, segar, bersih, ramah.\nTujuan: nilai 0. Tujuan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, membuang sampah, kantin bersih, kantin sehat, mengedukasi siswa, menyadarkan siswa.', '[]', 'auto', 'revision', 1, 0, NULL, '2026-07-21 04:05:02');
...
(2, 1, 1, 1, 1, 1, 4, 1, 1, 'revision', 'auto', NULL, NULL, '2026-04-29 11:13:40', '2026-07-21 03:26:27'),
...
(5, 1, 2, 0, 0, 0, 3, 0, 1, 'revision', 'auto', NULL, NULL, '2026-07-16 03:26:20', '2026-07-21 04:05:02');
...
(1, 1, 1, 31, 1, 'completed', 24, 4, 4, '2026-07-02 07:17:00', '2026-07-21 03:11:06', '2026-07-21 03:11:06', '2026-07-02 07:17:00', 'Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial: nilai 4. Kategori proyek sangat tepat dan sesuai konteks sekolah.\nConstraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini: nilai 4. Constraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini sudah memenuhi nilai minimal. Jawaban sudah memuat unsur kurang dari 5 detik, mudah dipahami, tidak menggurui, tidak galak, tidak mengancam. Agar lebih lengkap, kamu masih bisa menambahkan unsur visual sederhana.\nDeliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya: nilai 4. Output desain dan lokasi penempatan sangat jelas.\nGoals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini: nilai 4. Tujuan perubahan perilaku sangat jelas dan sesuai masalah.\nProject Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan: nilai 4. Project Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan sudah memenuhi nilai minimal. Jawaban sudah memuat unsur hemat air, keran terbuka, lupa tutup keran, boros air, toilet. Agar lebih lengkap, kamu masih bisa menambahkan unsur sekolah, siswa.\nTarget Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka: nilai 4. Target Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka sudah memenuhi nilai minimal. Jawaban sudah memuat unsur remaja, pelajar sekolah, pengguna toilet, siswa yang melintas. Agar lebih lengkap, kamu masih bisa menambahkan unsur siswa smk.\nThe Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol: nilai 4. Pesan utama jelas, singkat, dan sesuai tujuan poster.\nTimeline Kapan Desain Ini Harus Selesai: nilai 4. Timeline realistis dan sesuai proyek latihan kelas.', '[{\"fieldKey\":\"category_industry_di_bidang_apa_proyek_ini_berjalan_pendidikan_komersial_atau_sosial\",\"score\":4,\"matchedKeywords\":[\"pendidikan\",\"sekolah\",\"smk\",\"kampanye hemat air\",\"lingkungan sekolah\",\"masyarakat\"],\"missingKeywords\":[],\"note\":\"Kategori proyek sangat tepat dan sesuai konteks sekolah.\",\"suggestion\":\"Bagian Category Industry Di Bidang Apa Proyek Ini Berjalan Pendidikan Komersial Atau Sosial sudah cukup. Jawaban dapat dibuat lebih kuat dengan penjelasan yang lebih rinci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"constraints_apa_saja_batasan_atau_tantangan_teknis_yang_harus_diperhatikan_dalam_desain_ini\",\"score\":4,\"matchedKeywords\":[\"kurang dari 5 detik\",\"mudah dipahami\",\"tidak menggurui\",\"tidak galak\",\"tidak mengancam\",\"audiens melintas\"],\"missingKeywords\":[\"visual sederhana\"],\"note\":\"Constraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini sudah memenuhi nilai minimal. Jawaban sudah memuat unsur kurang dari 5 detik, mudah dipahami, tidak menggurui, tidak galak, tidak mengancam. Agar lebih lengkap, kamu masih bisa menambahkan unsur visual sederhana.\",\"suggestion\":\"Perbaiki bagian Constraints Apa Saja Batasan Atau Tantangan Teknis Yang Harus Diperhatikan Dalam Desain Ini dengan menambahkan unsur: visual sederhana. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"deliverables_apa_output_fisik_desainnya_dan_di_mana_lokasi_penempatannya\",\"score\":4,\"matchedKeywords\":[\"poster cetak\",\"pintu toilet\",\"kamar mandi sekolah\",\"setiap pintu toilet\",\"media cetak\"],\"missingKeywords\":[],\"note\":\"Output desain dan lokasi penempatan sangat jelas.\",\"suggestion\":\"Bagian Deliverables Apa Output Fisik Desainnya Dan Di Mana Lokasi Penempatannya sudah cukup. Jawaban dapat dibuat lebih kuat dengan penjelasan yang lebih rinci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"goals_objectives_perubahan_perilaku_apa_yang_diinginkan_sekolah_setelah_siswa_melihat_poster_ini\",\"score\":4,\"matchedKeywords\":[\"siswa menutup keran\",\"hemat air\",\"mengurangi pemborosan air\",\"membangun kesadaran\",\"tidak lupa menutup keran\"],\"missingKeywords\":[],\"note\":\"Tujuan perubahan perilaku sangat jelas dan sesuai masalah.\",\"suggestion\":\"Bagian Goals Objectives Perubahan Perilaku Apa Yang Diinginkan Sekolah Setelah Siswa Melihat Poster Ini sudah cukup. Jawaban dapat dibuat lebih kuat dengan penjelasan yang lebih rinci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"project_overview_apa_nama_proyek_ini_dan_masalah_utama_apa_yang_ingin_diselesaikan\",\"score\":4,\"matchedKeywords\":[\"hemat air\",\"keran terbuka\",\"lupa tutup keran\",\"boros air\",\"toilet\",\"kamar mandi\",\"hemat\"],\"missingKeywords\":[\"sekolah\",\"siswa\"],\"note\":\"Project Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan sudah memenuhi nilai minimal. Jawaban sudah memuat unsur hemat air, keran terbuka, lupa tutup keran, boros air, toilet. Agar lebih lengkap, kamu masih bisa menambahkan unsur sekolah, siswa.\",\"suggestion\":\"Perbaiki bagian Project Overview Apa Nama Proyek Ini Dan Masalah Utama Apa Yang Ingin Diselesaikan dengan menambahkan unsur: sekolah, siswa. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"target_audience_siapa_sasaran_utamanya_bagaimana_karakteristik_usia_mereka\",\"score\":4,\"matchedKeywords\":[\"remaja\",\"pelajar sekolah\",\"pengguna toilet\",\"siswa yang melintas\"],\"missingKeywords\":[\"siswa smk\"],\"note\":\"Target Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka sudah memenuhi nilai minimal. Jawaban sudah memuat unsur remaja, pelajar sekolah, pengguna toilet, siswa yang melintas. Agar lebih lengkap, kamu masih bisa menambahkan unsur siswa smk.\",\"suggestion\":\"Perbaiki bagian Target Audience Siapa Sasaran Utamanya Bagaimana Karakteristik Usia Mereka dengan menambahkan unsur: siswa smk. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"the_message_apa_pesan_kunci_atau_slogan_utama_yang_harus_menonjol\",\"score\":4,\"matchedKeywords\":[\"tutup keran\",\"hemat air\",\"jangan biarkan air terbuang\",\"pakai air secukupnya\",\"air berharga\"],\"missingKeywords\":[],\"note\":\"Pesan utama jelas, singkat, dan sesuai tujuan poster.\",\"suggestion\":\"Bagian The Message Apa Pesan Kunci Atau Slogan Utama Yang Harus Menonjol sudah cukup. Jawaban dapat dibuat lebih kuat dengan penjelasan yang lebih rinci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true},{\"fieldKey\":\"timeline_kapan_desain_ini_harus_selesai\",\"score\":4,\"matchedKeywords\":[\"1 hari\",\"2 hari\",\"3 hari\",\"beberapa jam\",\"sketsa\",\"desain selesai\"],\"missingKeywords\":[],\"note\":\"Timeline realistis dan sesuai proyek latihan kelas.\",\"suggestion\":\"Bagian Timeline Kapan Desain Ini Harus Selesai sudah cukup. Jawaban dapat dibuat lebih kuat dengan penjelasan yang lebih rinci.\",\"reviewStatus\":\"auto_graded_passed\",\"isPassed\":true}]'),
(2, 1, 1, 33, 2, 'unlocked', 25, 0, 1, '2026-07-21 03:11:06', '2026-07-21 03:26:27', NULL, '2026-07-02 07:17:00', 'Apakah Pesan Utama Yang Langsung Terlihat Jelaskan: nilai 0. Apakah Pesan Utama Yang Langsung Terlihat Jelaskan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur promosi tempat wisata, mempromosikan wisata, arbuckle, taman hewan arbuckle, kebun binatang arbuckle, wisata keluarga.\nApa Elemen Yang Dominan Warna Tipografi Layout Dll: nilai 0. Apa Elemen Yang Dominan Warna Tipografi Layout Dll masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur warna mencolok, warna terang, warna cerah, warna merah, warna biru, warna kuning.\nApa Tujuan Desain Tersebut: nilai 0. Apa Tujuan Desain Tersebut masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur promosi wisata, mempromosikan wisata, iklan tempat wisata, mengenalkan tempat wisata, taman hiburan, kebun binatang.\nBagian Mana Yang Membingungkan: nilai 0. Bagian Mana Yang Membingungkan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur terlalu banyak teks, kebanyakan tulisan, informasi berlebihan, font kecil, tulisan kekecilan, teks terlalu kecil.\nBagian Yang Paling Pertama Menarik Perhatian: nilai 0. Bagian Yang Paling Pertama Menarik Perhatian masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur headline, judul besar, tulisan besar, teks utama, kata rediscover, rediscover.\nSebutkan 3 Masalah Menurut Hierarki Visual: nilai 0. Sebutkan 3 Masalah Menurut Hierarki Visual masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur pesan utama tidak menonjol, tidak ada yang menonjol, judul tidak kelihatan, fokusnya hilang, urutan baca membingungkan, alur baca bingung.\nSebutkan 3 Masalah Pada Elemen Desainnya: nilai 0. Sebutkan 3 Masalah Pada Elemen Desainnya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur warna terlalu banyak, warna ramai, warna pusing, warna tabrakan, warna mencolok, warna norak.\nSebutkan 3 Masalah Pada Prinsip Desainnya Kontras Keseimbangan Dll: nilai 0. Sebutkan 3 Masalah Pada Prinsip Desainnya Kontras Keseimbangan Dll masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur kontras berlebihan, kontras kurang, warna tabrakan, tidak kelihatan, terlalu mencolok, keseimbangan buruk.\nSiapa Target Audiensnya: nilai 0. Siapa Target Audiensnya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur keluarga, keluarga muda, anak-anak, anak kecil, anak sekolah, wisatawan.', '[{\"fieldKey\":\"apakah_pesan_utama_yang_langsung_terlihat_jelaskan\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"promosi tempat wisata\",\"mempromosikan wisata\",\"arbuckle\",\"taman hewan arbuckle\",\"kebun binatang arbuckle\",\"wisata keluarga\",\"liburan keluarga\",\"rekreasi keluarga\",\"taman hewan\",\"taman safari\",\"animal theme park\",\"mengajak berkunjung\",\"mengajak liburan\",\"mengundang wisatawan\",\"berkunjung ke arbuckle\"],\"note\":\"Apakah Pesan Utama Yang Langsung Terlihat Jelaskan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur promosi tempat wisata, mempromosikan wisata, arbuckle, taman hewan arbuckle, kebun binatang arbuckle, wisata keluarga.\",\"suggestion\":\"Perbaiki bagian Apakah Pesan Utama Yang Langsung Terlihat Jelaskan dengan menambahkan unsur: promosi tempat wisata, mempromosikan wisata, arbuckle, taman hewan arbuckle, kebun binatang arbuckle. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"apa_elemen_yang_dominan_warna_tipografi_layout_dll\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"warna mencolok\",\"warna terang\",\"warna cerah\",\"warna merah\",\"warna biru\",\"warna kuning\",\"ngejreng\",\"kontras\",\"gambar hewan\",\"gambar binatang\",\"ada singa\",\"foto hewan\",\"banyak ilustrasi\",\"banyak gambar\",\"tipografi banyak\",\"tulisan banyak\",\"font banyak\",\"teks penuh\",\"layout padat\",\"layout penuh\",\"tata letak sesak\",\"ramai sekali\",\"penuh komponen\"],\"note\":\"Apa Elemen Yang Dominan Warna Tipografi Layout Dll masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur warna mencolok, warna terang, warna cerah, warna merah, warna biru, warna kuning.\",\"suggestion\":\"Perbaiki bagian Apa Elemen Yang Dominan Warna Tipografi Layout Dll dengan menambahkan unsur: warna mencolok, warna terang, warna cerah, warna merah, warna biru. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"apa_tujuan_desain_tersebut\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"promosi wisata\",\"mempromosikan wisata\",\"iklan tempat wisata\",\"mengenalkan tempat wisata\",\"taman hiburan\",\"kebun binatang\",\"kebun binatang arbuckle\",\"taman safari\",\"menarik pengunjung\",\"mengajak orang datang\",\"menarik wisatawan\",\"liburan ke arbuckle\",\"berkunjung ke arbuckle\",\"arbuckle\"],\"note\":\"Apa Tujuan Desain Tersebut masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur promosi wisata, mempromosikan wisata, iklan tempat wisata, mengenalkan tempat wisata, taman hiburan, kebun binatang.\",\"suggestion\":\"Perbaiki bagian Apa Tujuan Desain Tersebut dengan menambahkan unsur: promosi wisata, mempromosikan wisata, iklan tempat wisata, mengenalkan tempat wisata, taman hiburan. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"bagian_mana_yang_membingungkan\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"terlalu banyak teks\",\"kebanyakan tulisan\",\"informasi berlebihan\",\"font kecil\",\"tulisan kekecilan\",\"teks terlalu kecil\",\"informasi bertumpuk\",\"tulisan menumpuk\",\"data campur aduk\",\"layout penuh\",\"tata letak sesak\",\"posisi mepet\",\"ramai banget\",\"penuh komponen\",\"pesan tidak jelas\",\"maksudnya tidak tahu\",\"alurnya membingungkan\",\"sulit dibaca\",\"pusing membacanya\",\"susah dipahami\",\"tidak kelihatan\"],\"note\":\"Bagian Mana Yang Membingungkan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur terlalu banyak teks, kebanyakan tulisan, informasi berlebihan, font kecil, tulisan kekecilan, teks terlalu kecil.\",\"suggestion\":\"Perbaiki bagian Bagian Mana Yang Membingungkan dengan menambahkan unsur: terlalu banyak teks, kebanyakan tulisan, informasi berlebihan, font kecil, tulisan kekecilan. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"bagian_yang_paling_pertama_menarik_perhatian\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"headline\",\"judul besar\",\"tulisan besar\",\"teks utama\",\"kata rediscover\",\"rediscover\",\"gambar harimau\",\"foto macan\",\"harimau besar\",\"singa\",\"gambar hewan\",\"gambar binatang\",\"foto hewan besar\",\"warna mencolok\",\"warna terang\",\"warna cerah\",\"background kontras\",\"ngejreng\",\"latar belakang cerah\"],\"note\":\"Bagian Yang Paling Pertama Menarik Perhatian masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur headline, judul besar, tulisan besar, teks utama, kata rediscover, rediscover.\",\"suggestion\":\"Perbaiki bagian Bagian Yang Paling Pertama Menarik Perhatian dengan menambahkan unsur: headline, judul besar, tulisan besar, teks utama, kata rediscover. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"sebutkan_3_masalah_menurut_hierarki_visual\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"pesan utama tidak menonjol\",\"tidak ada yang menonjol\",\"judul tidak kelihatan\",\"fokusnya hilang\",\"urutan baca membingungkan\",\"alur baca bingung\",\"membacanya acak\",\"tidak tahu mulai membaca dari mana\",\"semua terlihat penting\",\"semuanya mencolok\",\"ramai semua\",\"rebutan perhatian\",\"headline kalah\",\"judulnya kekecilan\",\"judul tertutup gambar\",\"call to action tidak jelas\",\"tombol tidak kelihatan\",\"perintah tidak jelas\",\"informasi bertumpuk\",\"tulisan menumpuk\",\"teks berantakan\"],\"note\":\"Sebutkan 3 Masalah Menurut Hierarki Visual masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur pesan utama tidak menonjol, tidak ada yang menonjol, judul tidak kelihatan, fokusnya hilang, urutan baca membingungkan, alur baca bingung.\",\"suggestion\":\"Perbaiki bagian Sebutkan 3 Masalah Menurut Hierarki Visual dengan menambahkan unsur: pesan utama tidak menonjol, tidak ada yang menonjol, judul tidak kelihatan, fokusnya hilang, urutan baca membingungkan. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"sebutkan_3_masalah_pada_elemen_desainnya\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"warna terlalu banyak\",\"warna ramai\",\"warna pusing\",\"warna tabrakan\",\"warna mencolok\",\"warna norak\",\"warna ngejreng\",\"warna-warni\",\"tidak nyambung\",\"tipografi tidak konsisten\",\"font beda\",\"font ganti\",\"font acak\",\"font banyak\",\"tulisan berubah\",\"jenis tulisan campur aduk\",\"tidak rapi\",\"kurang serasi\",\"font kecil\",\"tulisan kecil\",\"teks kecil\",\"kekecilan\",\"kurang besar\",\"tidak kelihatan\",\"susah dibaca\",\"samar\",\"tidak jelas\",\"gambar terlalu ramai\",\"gambar banyak\",\"gambar numpuk\",\"gambar berantakan\",\"kebanyakan gambar\",\"visual ramai\",\"penuh gambar\",\"objek padat\",\"layout padat\",\"tata letak penuh\",\"layout sesak\",\"tampilan penuh\",\"posisi mepet\",\"komponen dekat\",\"menumpuk\",\"berantakan\",\"tidak teratur\",\"ruang kosong kurang\",\"ruang sempit\",\"ruang dikit\",\"kurang space\",\"tidak ada sela\",\"kurang jarak\",\"kemepetan\",\"tidak ada tempat bernapas\"],\"note\":\"Sebutkan 3 Masalah Pada Elemen Desainnya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur warna terlalu banyak, warna ramai, warna pusing, warna tabrakan, warna mencolok, warna norak.\",\"suggestion\":\"Perbaiki bagian Sebutkan 3 Masalah Pada Elemen Desainnya dengan menambahkan unsur: warna terlalu banyak, warna ramai, warna pusing, warna tabrakan, warna mencolok. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"sebutkan_3_masalah_pada_prinsip_desainnya_kontras_keseimbangan_dll\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"kontras berlebihan\",\"kontras kurang\",\"warna tabrakan\",\"tidak kelihatan\",\"terlalu mencolok\",\"keseimbangan buruk\",\"tidak seimbang\",\"berat sebelah\",\"miring\",\"tidak simetris\",\"alignment tidak rapi\",\"tidak lurus\",\"tidak rata\",\"berantakan\",\"menumpuk\",\"proximity buruk\",\"terlalu mepet\",\"terlalu jauh\",\"berjauhan\",\"tidak berkelompok\",\"emphasis tidak jelas\",\"penekanan kurang\",\"tidak ada fokus\",\"mana yang penting\",\"kesatuan kurang\",\"tidak menyatu\",\"tidak serasi\",\"acak-acakan\",\"campur aduk\"],\"note\":\"Sebutkan 3 Masalah Pada Prinsip Desainnya Kontras Keseimbangan Dll masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur kontras berlebihan, kontras kurang, warna tabrakan, tidak kelihatan, terlalu mencolok, keseimbangan buruk.\",\"suggestion\":\"Perbaiki bagian Sebutkan 3 Masalah Pada Prinsip Desainnya Kontras Keseimbangan Dll dengan menambahkan unsur: kontras berlebihan, kontras kurang, warna tabrakan, tidak kelihatan, terlalu mencolok. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"siapa_target_audiensnya\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"keluarga\",\"keluarga muda\",\"anak-anak\",\"anak kecil\",\"anak sekolah\",\"wisatawan\",\"turis\",\"pelancong\",\"pengunjung\",\"orang tua\",\"bapak ibu\",\"rombongan keluarga\",\"masyarakat umum\",\"semua umur\",\"liburan keluarga\"],\"note\":\"Siapa Target Audiensnya masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur keluarga, keluarga muda, anak-anak, anak kecil, anak sekolah, wisatawan.\",\"suggestion\":\"Perbaiki bagian Siapa Target Audiensnya dengan menambahkan unsur: keluarga, keluarga muda, anak-anak, anak kecil, anak sekolah. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false}]'),
...
(792, 1, 2, 37, 1, 'unlocked', 26, 0, 3, '2026-07-16 03:26:06', '2026-07-21 04:05:02', NULL, '2026-07-16 03:26:06', 'Elemen Wajib Visual Identitas: nilai 0. Elemen Wajib Visual Identitas masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur logo sekolah, tempat sampah, buang sampah, ilustrasi anak, gambar kantin, meja makan.\nPesan Utama: nilai 0. Pesan Utama masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, jagalah kebersihan, rapikan meja, kantin bersih, perut sehat, bersihkan mejamu.\nProject Overview: nilai 0. Project Overview masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur poster kampanye, poster kebersihan, kantin sekolah, kebersihan kantin, membuat poster, mendesain poster.\nSpesifikasi Teknis Output Media Ukuran Software: nilai 0. Spesifikasi Teknis Output Media Ukuran Software masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ukuran A3, poster cetak, poster digital, instagram, feed, adobe illustrator.\nTarget Audiens: nilai 0. Target Audiens masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur seluruh siswa, warga sekolah, semua murid, siswa guru, pengunjung kantin, pedagang kantin.\nTone Mood Nuansa Warna: nilai 0. Tone Mood Nuansa Warna masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ceria, bersahabat, playful, segar, bersih, ramah.\nTujuan: nilai 0. Tujuan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, membuang sampah, kantin bersih, kantin sehat, mengedukasi siswa, menyadarkan siswa.', '[{\"fieldKey\":\"elemen_wajib_visual_identitas\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"logo sekolah\",\"tempat sampah\",\"buang sampah\",\"ilustrasi anak\",\"gambar kantin\",\"meja makan\",\"maskot\",\"slogan\",\"jargon\",\"logo osis\",\"gambar makanan\",\"tulisan ajakan\",\"gambar piring\",\"ikon kebersihan\",\"teks utama\"],\"note\":\"Elemen Wajib Visual Identitas masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur logo sekolah, tempat sampah, buang sampah, ilustrasi anak, gambar kantin, meja makan.\",\"suggestion\":\"Perbaiki bagian Elemen Wajib Visual Identitas dengan menambahkan unsur: logo sekolah, tempat sampah, buang sampah, ilustrasi anak, gambar kantin. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"pesan_utama\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"buang sampah\",\"jagalah kebersihan\",\"rapikan meja\",\"kantin bersih\",\"perut sehat\",\"bersihkan mejamu\",\"budayakan antre\",\"jangan sembarangan\",\"tanggung jawab\",\"taruh piring\",\"bersihkan meja\",\"jaga kantin\",\"dilarang nyampah\",\"buanglah sampah\"],\"note\":\"Pesan Utama masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, jagalah kebersihan, rapikan meja, kantin bersih, perut sehat, bersihkan mejamu.\",\"suggestion\":\"Perbaiki bagian Pesan Utama dengan menambahkan unsur: buang sampah, jagalah kebersihan, rapikan meja, kantin bersih, perut sehat. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"project_overview\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"poster kampanye\",\"poster kebersihan\",\"kantin sekolah\",\"kebersihan kantin\",\"membuat poster\",\"mendesain poster\",\"merancang poster\",\"sketsa poster\",\"mind mapping\",\"tugas poster\",\"projek poster\",\"bikin poster\",\"rencana desain\",\"konsep poster\",\"gambaran umum\",\"deskripsi tugas\"],\"note\":\"Project Overview masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur poster kampanye, poster kebersihan, kantin sekolah, kebersihan kantin, membuat poster, mendesain poster.\",\"suggestion\":\"Perbaiki bagian Project Overview dengan menambahkan unsur: poster kampanye, poster kebersihan, kantin sekolah, kebersihan kantin, membuat poster. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"spesifikasi_teknis_output_media_ukuran_software\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"ukuran A3\",\"poster cetak\",\"poster digital\",\"instagram\",\"feed\",\"adobe illustrator\",\"coreldraw\",\"canva\",\"photoshop\",\"resolusi 300\",\"cmyk\",\"png\",\"jpeg\",\"cetak A3\",\"cetakan fisik\",\"media sosial\",\"format png\"],\"note\":\"Spesifikasi Teknis Output Media Ukuran Software masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ukuran A3, poster cetak, poster digital, instagram, feed, adobe illustrator.\",\"suggestion\":\"Perbaiki bagian Spesifikasi Teknis Output Media Ukuran Software dengan menambahkan unsur: ukuran A3, poster cetak, poster digital, instagram, feed. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"target_audiens\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"seluruh siswa\",\"warga sekolah\",\"semua murid\",\"siswa guru\",\"pengunjung kantin\",\"pedagang kantin\",\"penjual kantin\",\"staf sekolah\",\"siswa siswi\",\"anak SMK\",\"warga kantin\",\"pembeli kantin\",\"semua warga\",\"remaja sekolah\",\"guru karyawan\"],\"note\":\"Target Audiens masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur seluruh siswa, warga sekolah, semua murid, siswa guru, pengunjung kantin, pedagang kantin.\",\"suggestion\":\"Perbaiki bagian Target Audiens dengan menambahkan unsur: seluruh siswa, warga sekolah, semua murid, siswa guru, pengunjung kantin. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"tone_mood_nuansa_warna\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"ceria\",\"bersahabat\",\"playful\",\"segar\",\"bersih\",\"ramah\",\"warna hijau\",\"warna biru\",\"warna cerah\",\"warna pastel\",\"kontras\",\"higienis\",\"terang\",\"nuansa alam\",\"hijau daun\",\"kuning cerah\",\"simpel segar\",\"eye catching\"],\"note\":\"Tone Mood Nuansa Warna masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur ceria, bersahabat, playful, segar, bersih, ramah.\",\"suggestion\":\"Perbaiki bagian Tone Mood Nuansa Warna dengan menambahkan unsur: ceria, bersahabat, playful, segar, bersih. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false},{\"fieldKey\":\"tujuan\",\"score\":0,\"matchedKeywords\":[],\"missingKeywords\":[\"buang sampah\",\"membuang sampah\",\"kantin bersih\",\"kantin sehat\",\"mengedukasi siswa\",\"menyadarkan siswa\",\"rapikan meja\",\"membersihkan meja\",\"kenyamanan kantin\",\"mengurangi sampah\",\"sadar lingkungan\",\"kantin rapi\",\"dilarang nyampah\",\"tempat sampah\",\"higienitas kantin\",\"lalat hilang\"],\"note\":\"Tujuan masih perlu revisi. Sistem belum menemukan unsur utama yang diminta. Tambahkan unsur buang sampah, membuang sampah, kantin bersih, kantin sehat, mengedukasi siswa, menyadarkan siswa.\",\"suggestion\":\"Perbaiki bagian Tujuan dengan menambahkan unsur: buang sampah, membuang sampah, kantin bersih, kantin sehat, mengedukasi siswa. Jelaskan menggunakan kalimat sendiri, jangan hanya menulis kata kunci.\",\"reviewStatus\":\"revision\",\"isPassed\":false}]'),
(794, 1, 2, 38, 2, 'locked', NULL, 0, 0, NULL, NULL, NULL, '2026-07-16 03:26:06', NULL, NULL),
(796, 1, 2, 39, 3, 'locked', NULL, 0, 0, NULL, NULL, NULL, '2026-07-16 03:26:06', NULL, NULL),
(798, 1, 2, 40, 4, 'locked', NULL, 0, 0, NULL, NULL, NULL, '2026-07-16 03:26:06', NULL, NULL),
(1310, 1, 3, 41, 1, 'unlocked', NULL, 0, 0, '2026-07-19 04:39:46', NULL, NULL, '2026-07-19 04:39:46', NULL, NULL),
(1312, 1, 3, 42, 2, 'locked', NULL, 0, 0, NULL, NULL, NULL, '2026-07-19 04:39:46', NULL, NULL),
(1315, 1, 3, 45, 3, 'locked', NULL, 0, 0, NULL, NULL, NULL, '2026-07-19 04:39:46', NULL, NULL);
...
--
-- Indexes for table `pjbl_learning_evaluations`
--
ALTER TABLE `pjbl_learning_evaluations`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_student_learning_evaluation` (`user_id`,`pertemuan`),
  ADD KEY `idx_learning_eval_user` (`user_id`),
  ADD KEY `idx_learning_eval_pertemuan` (`pertemuan`);

--
-- Indexes for table `pjbl_learning_evaluation_scores`
--
ALTER TABLE `pjbl_learning_evaluation_scores`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_evaluation_item` (`evaluation_id`,`item_key`),
  ADD KEY `idx_eval_score_evaluation` (`evaluation_id`);

--
-- Indexes for table `pjbl_project_plans`
--
ALTER TABLE `pjbl_project_plans`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_user_project_plan` (`user_id`,`pertemuan`);

--
-- Indexes for table `pjbl_project_schedules`
--
ALTER TABLE `pjbl_project_schedules`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_project_schedule_plan` (`plan_id`);
...
--
-- AUTO_INCREMENT for table `pjbl_learning_evaluations`
--
ALTER TABLE `pjbl_learning_evaluations`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `pjbl_learning_evaluation_scores`
--
ALTER TABLE `pjbl_learning_evaluation_scores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `pjbl_project_plans`
--
ALTER TABLE `pjbl_project_plans`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `pjbl_project_schedules`
--
ALTER TABLE `pjbl_project_schedules`
...
--
-- Constraints for table `pjbl_learning_evaluation_scores`
--
ALTER TABLE `pjbl_learning_evaluation_scores`
  ADD CONSTRAINT `fk_learning_eval_score` FOREIGN KEY (`evaluation_id`) REFERENCES `pjbl_learning_evaluations` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `pjbl_project_schedules`
--
ALTER TABLE `pjbl_project_schedules`
  ADD CONSTRAINT `fk_project_schedule_plan` FOREIGN KEY (`plan_id`) REFERENCES `pjbl_project_plans` (`id`) ON DELETE CASCADE;
