...
import MonitoringProyek from "./pages/guru/MonitoringProyek";
import Evaluasi from "./pages/guru/Evaluasi";

import DesainProyekPage from "./pages/DesainProyekPage";
import EvaluasiBelajarPage from "./pages/EvaluasiBelajarPage";
